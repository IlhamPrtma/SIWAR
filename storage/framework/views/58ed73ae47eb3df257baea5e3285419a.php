...
<body style="background-color: black">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0" style="background-color: black">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <img src="<?php echo e(asset('images/foodies-chef-photo.png')); ?>" alt="Chef Icon">
                                    ...
                                    <form class="user" method="POST" action="<?php echo e(route('login.auth')); ?>">
                                        <?php echo csrf_field(); ?> 
                            ...
                            <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background-image: url('<?php echo e(asset('images/image-chef.png')); ?>')"></div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        Swal.fire({
            title: "Login Gagal",
            text: <?php echo json_encode($errors->first('credentials'), 15, 512) ?>,
            icon: "error"
        });
    </script>
    <?php endif; ?>
    ...
    <script>
        Swal.fire({
            title: "Login Gagal",
            text: <?php echo json_encode($errors->first('username'), 15, 512) ?>,
            icon: "error"
        });
    </script>
    <?php endif; ?>
    ...
    <script>
        Swal.fire({
            title: "Login Gagal",
            text: <?php echo json_encode($errors->first('password'), 15, 512) ?>,
            icon: "error"
        });
    </script>
    <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\order-food-app-main\resources\views/auth/login.blade.php ENDPATH**/ ?>